...
PARTS = [
    ("r-leg", "stump", "LV Stump Right Leg", "lv-stump-r-leg",
     "A raw stump. Almost no push-off.", 3, 30, 0.15, 0.20, 0.10, 1.0, 1.0, 1.0, 1.0, 0.4),
    ("r-leg", "bud", "LV Budding Right Leg", "lv-bud-r-leg",
     "Flesh is budding on the stump.", 3, 45, 0.35, 0.40, 0.25, 1.0, 1.0, 1.0, 1.0, 0.8),
    ...
    ("l-leg", "bud", "LV Budding Left Leg", "lv-bud-l-leg",
     "Flesh is budding on the stump.", 2, 45, 0.35, 0.40, 0.25, 1.0, 1.0, 1.0, 1.0, 0.8),
    ...
    ("r-arm", "bud", "LV Budding Right Arm", "lv-bud-r-arm",
     "Fingers are suggestions, not facts.", 1, 45, 1.0, 1.0, 0.25, 0.35, 0.40, 0.30, 0.25, 0.6),
    ...
    ("l-arm", "bud", "LV Budding Left Arm", "lv-bud-l-arm",
     "Fingers are suggestions, not facts.", 0, 45, 1.0, 1.0, 0.25, 0.35, 0.40, 0.30, 0.25, 0.6),
