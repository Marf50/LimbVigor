...
- [ ] **Loads a save.** World's End / any town. No crash. RE_Kenshi_log shows `LimbVigor: ready v1.8.5` then `HUD window up` then `HUD painted`. Must NOT assert GetRealAddress. Must NOT create skin `ProgressBar`. Must NOT log `HUD frame hook`.
