...
{
    return (lvHasSub(n, "LifeBar1Green") || lvHasSub(n, "LifeBar1Grey")
         || lvHasSub(n, "LifeBar1Red") || lvHasSub(n, "LifeBar1Yellow")
         || lvHasSub(n, "LifeBar1White") || lvHasSub(n, "LifeBar1Robot")
