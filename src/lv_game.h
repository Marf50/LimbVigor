...
void      LvWalkSelPanel(DatapanelGUI* panel); // keys + MyGUI exports + Goal/State neighbor walk
void      LvClearHud(DatapanelGUI* panel); // resource + Limb Vigor + lowercase limbs + leftover Regrowth/Wait
void      LvPaintHud(MedicalSystem* med, DatapanelGUI* panel, const CharSnap* snap); // v1.16: no paint
