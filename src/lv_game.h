...
void      LvClearHud(DatapanelGUI* panel); // clear LifeBar10 only — never touch LifeBar1
void      LvPaintHud(MedicalSystem* med, DatapanelGUI* panel, const CharSnap* snap); // Widget::setCaption LifeBar10 every tick, read-back
